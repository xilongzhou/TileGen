    ...
    def __init__(self, args, train, datasets=None):
        ...
        if datasets is None:
            if args.dataset=='Tile':
                ...
                datasets = SceneConfig.TRAIN_DATASETS_STONE if train else SceneConfig.TEST_DATASETS_STONE
                ...
                datasets = SceneConfig.TRAIN_DATASETS_METAL if train else SceneConfig.TEST_DATASETS_METAL
